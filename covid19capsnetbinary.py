...
def DataGenerator(train_batch, val_batch, IMG_SIZE):
    ...
    train_gen = datagen.flow_from_directory('E:\covbinary\covtrain',
                                            target_size=(IMG_SIZE, IMG_SIZE),
                                            color_mode='rgb', 
                                            class_mode='categorical',
                                            batch_size=train_batch)

    val_gen = datagen.flow_from_directory('E:\covbinary\covval', 
                                          target_size=(IMG_SIZE, IMG_SIZE),
                                          color_mode='rgb', 
                                          class_mode='categorical',
    ...
    test_gen = datagen.flow_from_directory('E:\covbinary\covtest', 
                                           target_size=(IMG_SIZE, IMG_SIZE),
                                           color_mode='rgb', 
                                           batch_size=1,
                                           class_mode='categorical',
...
CNnCapsNet_Binarymodel = Model(input_image, outputs=output)

CNnCapsNet_Binarymodel.summary()
...
CNnCapsNet_Binarymodel.compile(loss=margin_loss, optimizer='adam', metrics=['accuracy'])

hist=CNnCapsNet_Binarymodel.fit_generator(train,
                    epochs=epochs,
                    validation_data=val, 
...
pred=CNnCapsNet_Binarymodel.predict_generator(test,100)
