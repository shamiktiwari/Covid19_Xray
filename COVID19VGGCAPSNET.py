...
VGGCapsNetmodel.compile(loss='categorical_crossentropy', optimizer=SGD(lr=lr,decay=0.001, momentum=0.9), metrics=['accuracy'])

hist=VGGCapsNetmodel.fit_generator(train,
                    epochs=epochs,
                    validation_data=val, 
...
pred=VGGCapsNetmodel.predict(X_test, verbose=1)
